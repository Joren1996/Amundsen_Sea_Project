...
fig.suptitle('Longitudinal cross sections of zonal velocity in member '+str(members[-1])+' across shelf break at '+str(lon)+' degrees W')
ax=plt.subplot(2,2,1)
ax.set_title('Mean over 1920-1950')
img=ax.pcolor(dataU.YC, dataU.Z, dataU.mean(dim='ens').sel(time=slice('1920', '1950')).mean(dim='time'), cmap='seismic', vmin=-0.1, vmax=0.1)
...
plt.colorbar(img, label='Zonal velocity [m/s]', extend='both')
if lon==115:
...
img=ax.pcolor(dataU.YC, dataU.Z, dataU.mean(dim='ens').sel(time=slice('1980', '2010')).mean(dim='time'), cmap='seismic', vmin=-0.1, vmax=0.1)
...
img=ax.pcolor(dataU.YC, dataU.Z, dataU.mean(dim='ens').sel(time=slice('1980', '2010')).mean(dim='time')-dataU.mean(dim='ens').sel(time=slice('1920', '1950')).mean(dim='time'), cmap='seismic', vmin=-0.05, vmax=0.05)
#cn=ax.contour(q.YC, q.Z, q.mean(dim='ens').sel(time=slice('1980', '2010')).mean(dim='time'), [1027.5, 1027.6, 1027.7, 1027.8], colors='k')
#ax.clabel(cn, [1027.5, 1027.6, 1027.7, 1027.8])
plt.colorbar(img)
if lon==115:
...
img=ax.pcolor(dataU.YC, dataU.Z, dataU.sel(time=slice('1920', '2010')).polyfit(dim='time', deg=1).sel(degree=1, ens=0)['polyfit_coefficients'], cmap='seismic', vmin=-1e-20, vmax=1e-20)
#cn=ax.contour(q.YC, q.Z, q.mean(dim='ens').sel(time=slice('1980', '2010')).mean(dim='time'), [1027.5, 1027.6, 1027.7, 1027.8], colors='k')
#ax.clabel(cn, [1027.5, 1027.6, 1027.7, 1027.8])
plt.colorbar(img)
if lon==115:
...
fig.savefig('/data/hpcdata/users/grejan/mitgcm/03_output/slices/UVEL_slicesintime_member'+str(members[-1])+'_at_lon'+str(lon)+'.png')
...
fig=plt.figure(figsize=(20,10))
fig.suptitle('Longitudinal cross sections of slope of density in member '+str(members[-1])+' across shelf break at '+str(lon)+' degrees W')
ax=plt.subplot(2,2,1)
ax.set_title('Mean over 1920-1950')
img=ax.pcolor(dzdy.YC, dzdy.Z, dzdy.mean(dim='ens').sel(time=slice('1920', '1950')).mean(dim='time'), cmap='seismic', vmin=-2e-2, vmax=2e-2)
#cn=ax.contour(q.YC, q.Z, q.mean(dim='ens').sel(time=slice('1920', '1950')).mean(dim='time'), [1027.5, 1027.6, 1027.7, 1027.8], colors='k')
#ax.clabel(cn, [1027.5, 1027.6, 1027.7, 1027.8])
plt.colorbar(img, label='Density slope [m/m]', extend='min')
if lon==115:
    ax.set_xlim([-71.8, -71.1])
elif lon==123:
    ax.set_xlim([-73, -72])
...
ax=plt.subplot(2,2,2)
ax.set_title('Mean over 1980-2010')
img=ax.pcolor(dzdy.YC, dzdy.Z, dzdy.mean(dim='ens').sel(time=slice('1980', '2010')).mean(dim='time'), cmap='seismic', vmin=-2e-2, vmax=2e-2)
#cn=ax.contour(q.YC, q.Z, q.mean(dim='ens').sel(time=slice('1980', '2010')).mean(dim='time'), [1027.5, 1027.6, 1027.7, 1027.8], colors='k')
#ax.clabel(cn, [1027.5, 1027.6, 1027.7, 1027.8])
plt.colorbar(img, label='Density slope [m/m]', extend='min')
if lon==115:
...
ax=plt.subplot(2,2,3)
ax.set_title('Difference Mean1980to2010 - Mean1920to1950')
img=ax.pcolor(dzdy.YC, dzdy.Z, dzdy.mean(dim='ens').sel(time=slice('1980', '2010')).mean(dim='time')-dzdy.mean(dim='ens').sel(time=slice('1920', '1950')).mean(dim='time'), cmap='seismic', vmin=-1e-2, vmax=1e-2)
#cn=ax.contour(q.YC, q.Z, q.mean(dim='ens').sel(time=slice('1980', '2010')).mean(dim='time'), [1027.5, 1027.6, 1027.7, 1027.8], colors='k')
#ax.clabel(cn, [1027.5, 1027.6, 1027.7, 1027.8])
plt.colorbar(img)
if lon==115:
...
ax=plt.subplot(2,2,4)
ax.set_title('Trend 1920-2013')
img=ax.pcolor(dzdy.YC, dzdy.Z, dzdy.sel(time=slice('1920', '2010')).polyfit(dim='time', deg=1).sel(degree=1, ens=0)['polyfit_coefficients'], cmap='seismic', vmin=-5e-21, vmax=5e-21)
#cn=ax.contour(q.YC, q.Z, q.mean(dim='ens').sel(time=slice('1980', '2010')).mean(dim='time'), [1027.5, 1027.6, 1027.7, 1027.8], colors='k')
#ax.clabel(cn, [1027.5, 1027.6, 1027.7, 1027.8])
plt.colorbar(img)
if lon==115:
...
fig.savefig('/data/hpcdata/users/grejan/mitgcm/03_output/slices/ISOPYCNAL_slicesintime_member'+str(members[-1])+'_at_lon'+str(lon)+'.png')
